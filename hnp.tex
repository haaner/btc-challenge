...
$$k_i=s_i^{-1}(z_i+dr_i)\mbox{ mod } g$$
Insbesondere gilt: $$k_1-k_n=s_1^{-1}(z_1+dr_1) - s_n^{-1}(z_n+dr_n)\mbox{ mod } g$$ und nach einigen Umformungen ergibt sich: $$d=(r_ns_1-r_1s_n)^{-1}(s_nz_1-s_1z_n-s_1s_n(k_1-k_n))\mbox{ mod } g$$
